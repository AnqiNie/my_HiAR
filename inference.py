...
parser.add_argument("--data_path", type=str, help="Path to the prompt text file")
...
if args.checkpoint_path:
    ...
    if args.use_ema and 'generator_ema' in state_dict:
        ...
        if args.use_ema:
            print("Warning: EMA key not found in checkpoint, falling back to 'generator'")
        load_key = 'generator'
    raw_sd = state_dict[load_key]
    # Clean up FSDP/checkpoint wrapper/torch.compile prefixes
    clean_sd = {
